...
- **Поставщики** (вкладка «🚚 Поставки»): за деньги можно купить лот из 5 единиц любого
  открытого товара — дороже, чем вырастить (×1.45 + доставка), зато мгновенно.
  Лот сначала уходит в цеха, которым сырья не хватает, остаток — на полки.
  Так закрывают срочный заказ или дырку на прилавке.
...
- **Панель проблем** (кнопка ⚠️ слева внизу): пустые полки, забитые цеха, простой кассы,
