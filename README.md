...
Карта — **50×30 клеток**, пять помещений за своими стенами и заборами. Постройки стоят
с шагом 3 клетки, то есть между любыми двумя всегда **проход в две клетки**: можно пройти
мимо, никого не задев, и у каждой постройки остаётся минимум три свободные стороны
даже когда участок застроен целиком.
...
| Помещение | Мест | Что там |
|---|---|---|
| 🌱 Огород | 20 | помидоры, огурцы, картофель, пшеница, яблони в четыре ряда |
| 🐄 Загон | 12 | куры, коровы, свиньи за забором с калиткой; южная полоса под сено и поилки |
| 🍳 Цеха | 24 | салат-бар, пекарня, фритюрница, соковыжималка, сыроварня, гриль, кондитерская, пиццерия; у северных ворот — погрузка с поддонами |
| 🏬 Зал | 40 полок + 4 кассы | пять рядов полок с ценниками, подвесные указатели, прикассовая полоса, вход с тележками |
| 📦 Служебка | — | склад со стеллажами и холодильной камерой, кабинет, шкафчики и кулер для смены |
...
постройки** — проверено на 4720 точках при полностью застроенной карте, так что взять
«не то, что хотел» здесь физически невозможно.
